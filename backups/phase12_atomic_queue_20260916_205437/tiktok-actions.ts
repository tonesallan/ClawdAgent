...
/**
 * Recovers RUNNING actions left behind by an interrupted scheduler.
 *
 * This repository helper does not execute TikTok actions.
 * The production scheduler currently calls it only for the
 * read-only CHECK_FOLLOW_BACK action type.
 *
 * Attempts are preserved because entering RUNNING already consumed
 * the attempt before the interruption occurred.
 */
